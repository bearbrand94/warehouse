        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-body box-profile">
                  <h3 class="profile-username text-center">{{$bongkar_data->showid}}</h3>
                  ...
                  <ul class="list-group list-group-unbordered">
                    ...
                    <li class="list-group-item">
                      <b>No. DO</b> <a class="pull-right">{{$bongkar_data->droporder_id}}</a>
                    </li>
                    <li class="list-group-item">
                      <b>No. Truck</b> <a class="pull-right">{{$bongkar_data->truck_number}}</a>
                    </li>
                  </ul>
                </div>
                <!-- /.box-body -->
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" width="100%" cellspacing="0" id="t_item">
                        <thead id="th_item">
                          <th>#ID</th>
                          <th>Nama Barang</th>
                          <th class="text-center">Jumlah Bongkar</th>
                          <th class="text-center">Action</th>
                        </thead>
                        <tbody>
                          @foreach ($bongkar_data->detail as $detail)
                          <tr>
                            <td>{{ $detail->id }}</td>
