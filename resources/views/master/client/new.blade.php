    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
	        ...
	        <div class="form-group">
	        	...
	        	<div class="row">
	        		<div class="col-xs-6">
	        			<input type="text" class="form-control" id="client_phone1" name="client_phone1" placeholder="Telepon 1">
						@if($errors->has('phone1'))
						    <p><span class="text-warning">{{$errors->first('phone1')}}</span></p>
						@endif
	        		</div>
		            <div class="col-xs-6">
	        			<input type="text" class="form-control" id="client_phone2" name="client_phone2" placeholder="Telepon 2">
